...
public class IvStoreRoom {
    ...
    private Long storeHousSerialId;
    ...
    public Long getStoreHousSerialId() {
        return storeHousSerialId;
    }

    public void setStoreHousSerialId(Long storeHousSerialId) {
        this.storeHousSerialId = storeHousSerialId;
    }
