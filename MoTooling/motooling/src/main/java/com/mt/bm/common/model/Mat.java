...
public class Mat {
    ...
    public String getMatNameId() {
        return matNameId;
    }

    public void setMatNameId(String matNameId) {
        this.matNameId = matNameId == null ? null : matNameId.trim();
    }
    ...
    private String matCascadeType;
    public String getMatCascadeType() {
        return matCascadeType;
    }

    public void setMatCascadeType(String matCascadeType) {
        this.matCascadeType = matCascadeType == null ? null : matCascadeType.trim();
    }
}