package com.mt.common.core.statics;



import com.mt.common.core.config.IConfig;
...
public interface Constant {
	...
	/**地址**/
	static final String APPID = IConfig.get("public.appid");//前端域名
	static final String APPSECRET= IConfig.get("public.secret");//静态资源域名
