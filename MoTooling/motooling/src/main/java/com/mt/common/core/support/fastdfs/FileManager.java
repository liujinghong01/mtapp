package com.mt.common.core.support.fastdfs;

import com.alibaba.fastjson.JSON;
import com.mt.common.utils.PropertiesUtil;
import com.mt.csource.common.NameValuePair;
import com.mt.csource.fastdfs.*;
import com.mt.csource.fastdht.FastDHTClient;
import com.mt.csource.fastdht.KeyInfo;
...
public class FileManager implements Config {
	...
	static { // Initialize Fast DFS Client configurations
		try {
			...
			ClientGlobal.init(path + "fd/fdfs_client.conf");
			com.mt.csource.fastdht.ClientGlobal.init(path + "fd/fdht_client.conf");
		} catch (Exception e) {
			logger.error("", e);
		}
	}
