<template>
  <div class="mw-page page storage" v-nav="{hideNavbar:true}">
        ...
        <div class="content" v-show="tabIndex===1">
          <scroll class="page-content" :on-infinite="onInfinite" :on-refresh="onRefresh" style="-webkit-overflow-scrolling: touch">
            <swipe-item
              ...
              :canSwipe="false"
              v-for="item in list[1].inventoryList"
              class="req-item" v-on:ItemClick="onItemClick(item)"
              :obj="item"
              swipeItemText="删除"
    ...
    <div class="mw-page-footer">
      <div class="btns">
        <div class="btn" @click="$router.forward('/storage/storagePull/new')">
          新建出库单
        </div>
      </div>
    </div>
